			...
			<nav class="navbar navbar-expand-lg navbar-light">
				<div class="container">
					...
					<div class="collapse navbar-collapse offset" id="navbarSupportedContent">
                        ...
                        {{--  <a  href="#"> <i class="fa fa-sign-out" style="font-size:40px;color:rgb(80, 76, 76)"></i></a>  --}}
                        {{--  <li class="nav-item"><a href="{{ route('user.logout') }}" class="primary_btn " style=" text-transform: capitalize" >  logout </a></li>  --}}

                        @else

                        <a  class="primary_btn"  href="{{route('user.register')}}" style="font-size: 14px;text-transform: capitalize ;width: 150px;height: 50px " >Register/Login</a>
                    ...
                    <div class="collapse navbar-collapse  " id="navbarSupportedContent">
						...
						<div class="dropdown user_name_div show">
							<a class="btn  btn-outline-light dropdown-toggle" href="#" role="button" id="dropdownMenuLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="true">
                                {{@ Auth::user()->name }}
  ...
  <!-- Footer -->
	...
	<div class="footer-basic">
        <footer>
            ...
            <p class="copyright"><a style="color: rgb(13, 67, 116);" target="_blank" href="https://ksu.edu.sa">copyright : King Saud university</a> © 2022</p>
        </footer>
    </div>
